  ...
  return (
    <div>
        <div className='flex flex-wrap gap-8 w-full md:w-3/4 mx-auto  py-8'>
          {/* video over here */}
          <video width="420"  loop  autoPlay muted className='rounded-3xl overflow-hidden mx-2 md:mx-0'>
          <source src={video_url}   width="320" height="500" />
          </video>
          
          <div className='w-full lg:w-1/2 rounded-xl bg-gray-bg text-white mx-2 md:mx-0 px-10 py-4  shadow-xl'>
