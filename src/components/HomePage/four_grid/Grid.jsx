    ...
    <div className='w-full flex flex-wrap gap-4  mx-auto  py-5 px-5  justify-center items-center '>
        ...
        <div className= 'w-[95%] md:w-[48%] overflow-hidden  relative'>
             ...
             <div className='absolute z-10 px-4 py-2 top-0 md:top-4 w-full flex flex-col gap-y-2 items-center  '>
              ...
              <NavLink  to={`/`} className='py-1 px-10 text-md  text-white rounded-full  border-2 border-white  shadow-2xl
              hover:bg-white hover:bg-opacity-20  transition-all duration-300'>Buy Now  </NavLink>
          </div>
        </div>
        ...
        <div className='w-[95%] md:w-[48%] overflow-hidden  relative' >
            ...
            <div className='absolute z-10 px-4 py-2 top-0 md:top-4 w-full flex flex-col gap-y-2 items-center  '>
              ...
              <NavLink  to={`/`} className='py-1 px-10 text-md  text-gray-600 rounded-full  border-2 border-gray-600  shadow-2xl
              hover:bg-white hover:bg-opacity-20  transition-all duration-300'>Buy Now  </NavLink>
          </div>
        </div>
        ...
        <div className='w-[95%] md:w-[48%] overflow-hidden relative '>
            ...
            <div className='absolute z-10 px-4 py-2 top-0 md:top-4 w-full flex flex-col gap-y-2 items-center  '>
              <h1 className='text-xl md:text-4xl  text-gray-300'>KRISHIMITRA A-10H</h1>
              <NavLink  to={`/`} className='py-1 px-10 text-md  text-gray-400 rounded-full  border-2 border-gray-400  shadow-2xl
              hover:bg-white hover:bg-opacity-20  transition-all duration-300'>Buy Now  </NavLink>
          </div>
